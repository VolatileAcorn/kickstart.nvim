...
```
git clone https://github.com/VolatileAcorn/kickstart.nvim.git %userprofile%\AppData\Local\nvim\
```

If you're using `powershell.exe`

```
git clone https://github.com/VolatileAcorn/kickstart.nvim.git $env:USERPROFILE\AppData\Local\nvim\
```
